class Ruby < Formula
  ...
  def rubygems_bindir
    OSPACK_PREFIX/"lib/ruby/gems/#{api_version}/bin"
  end
  ...
  def install
    ...
    #       https://github.com/Ospack/ospack/pull/12508
    ...
    args = %W[
      ...
      --with-sitedir=#{OSPACK_PREFIX}/lib/ruby/site_ruby
      --with-vendordir=#{OSPACK_PREFIX}/lib/ruby/vendor_ruby
    ...
    # Ruby has been configured to look in the OSPACK_PREFIX for the
  ...
  def post_install
    ...
    rm_r(Dir[OSPACK_PREFIX/"lib/ruby/gems/#{api_version}/gems/bundler-*"])
  ...
  def rubygems_config(api_version)
    <<~RUBY
      module Gem
        ...
        # https://github.com/ospack/core/issues/40872#issuecomment-542092547
        # https://github.com/ospack/core/pull/48329#issuecomment-584418161
  ...
  test do
    ...
    (testpath/"Gemfile").write <<~EOS
      ...
      gem 'github-markup'
    EOS
    system bin/"bundle", "exec", "ls" # https://github.com/ospack/core/issues/53247
