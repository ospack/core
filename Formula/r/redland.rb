class Redland < Formula
  ...
  test do
    (testpath/"test.c").write <<~C
      ...
      int main(int argc, char *argv[]) {
        ...
        statement = librdf_new_statement_from_nodes(
          ...
          librdf_new_node_from_literal(world, (const unsigned char*) "Ospack was here", NULL, 0)
        );
    ...
    expected = <<~EOS
      ...
      #{" " * 4}<ns0:title xmlns:ns0="http://purl.org/dc/elements/1.1/">Ospack was here</ns0:title>
      #{" " * 2}</rdf:Description>
    EOS
