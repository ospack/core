class ReginaRexx < Formula
  ...
  def install
    ...
    system "./configure", *std_configure_args,
                          "--with-addon-dir=#{OSPACK_PREFIX}/lib/regina-rexx/addons",
                          "--with-ospack-addon-dir=#{lib}/regina-rexx/addons"
    system "make"

    install_targets = OS.mac? ? ["installbase", "installospacklib"] : ["install"]
