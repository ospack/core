class Rpm < Formula
  ...
  def install
    ...
    # only rpm should go into OSPACK_CELLAR, not rpms built
    inreplace ["macros.in", "platform.in"], "@prefix@", OSPACK_PREFIX
    ...
    # work around Ospack's prefix scheme which sets Python3_SITEARCH outside of prefix
  ...
  test do
    ...
    assert_match (OSPACK_PREFIX/"share/doc/test").to_s, files
