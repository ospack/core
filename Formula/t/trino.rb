class Trino < Formula
  ...
  def install
    ...
    # size from MBs to GBs. Remove once Ospack is able to preserve hardlinks.
    # Ref: https://github.com/Ospack/ospack/pull/13154
    libexec.mkpath
  ...
  test do
    ...
    # https://github.com/ospack/core/pull/153348
