class Tesseract < Formula
  ...
  def install
    ...
    # which doesn't work for non-default ospack location
    ENV["LIBLEPT_HEADERSDIR"] = OSPACK_PREFIX/"include"

    ENV.cxx11

    system "./autogen.sh"
    system "./configure", "--datarootdir=#{OSPACK_PREFIX}/share",
  ...
  def caveats
    <<~EOS
      ...
      If you need any other supported languages, run `ospack install tesseract-lang`.
    EOS
  end
  ...
  test do
    ...
    resource("ospack-test_resource").stage do
