class Theharvester < Formula
  ...
  test do
    output = shell_output("#{bin}/theharvester -d ospack.github.io --limit 1 --source urlscan 2>&1")
    assert_match "docs.ospack.github.io", output
    assert_match "formulae.ospack.github.io", output
  end
end
