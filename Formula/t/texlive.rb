class Texlive < Formula
  ...
  livecheck do
    ...
    strategy :page_match do |page, regex|
      ...
      year_page = Ospack::Livecheck::Strategy.page_content(URI.join(@url, newest_year).to_s)
  ...
  # (https://github.com/ospack/core/issues/172769). Install BibLaTeX 3.20
  ...
  def install
    ...
    resources.each do |r|
      ...
      r.stage do
        if File.exist? "Makefile.PL"
          ...
          args += ["X11INC=#{OSPACK_PREFIX}/include", "X11LIB=#{OSPACK_PREFIX}/lib"] if r.name == "Tk"
    ...
    # Rewrite shebangs in some Python scripts so they use ospacked Python.
