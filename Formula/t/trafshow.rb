class Trafshow < Formula
...

  {
    ...
    patch :p0 do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/be6fd4a/trafshow/patch-#{name}"
      sha256 sha
    end
  end
  ...
  patch :p0 do
    on_sierra :or_newer do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/7ad7c77/trafshow/patch-pcap-version-sierra.diff"
