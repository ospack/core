class ActionValidator < Formula
  ...
  stable do
    ...
    patch do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/ffcaead14f73c08531313dcb7c300918db576c3b/action-validator/0.6.0-completion-manpage.patch"
