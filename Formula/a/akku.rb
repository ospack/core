class Akku < Formula
  ...
  test do
    system bin/"akku", "init", "ospacktest"
    assert_path_exists testpath/"ospacktest/ospacktest.sls"
    assert_match "akku-package (\"ospacktest\"", (testpath/"ospacktest/Akku.manifest").read
