class Aom < Formula
  ...
  def install
    ...
    system "cmake", "-S", ".", "-B", "ospackbuild", *args, *std_cmake_args
    system "cmake", "--build", "ospackbuild"
    system "cmake", "--install", "ospackbuild"
  end

  test do
    resource "ospack-bus_qcif_15fps.y4m" do
      url "https://media.xiph.org/video/derf/y4m/bus_qcif_15fps.y4m"
      sha256 "868fc3446d37d0c6959a48b68906486bd64788b2e795f0e29613cbb1fa73480e"
    end

    testpath.install resource("ospack-bus_qcif_15fps.y4m")
