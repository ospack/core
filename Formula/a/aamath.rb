class Aamath < Formula
  ...
  # Fix build on clang; patch by Ospack team
  # https://github.com/Ospack/ospack/issues/23872
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/85fa66a9/aamath/0.3.patch"
