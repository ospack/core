class Autojump < Formula
  ...
  def install
    ...
    inreplace prefix/"etc/profile.d/autojump.sh", "/usr/local", OSPACK_PREFIX
  ...
  def caveats
    <<~EOS
      ...
      If you use the Fish shell then add the following line to your ~/.config/fish/config.fish:
        [ -f #{OSPACK_PREFIX}/share/autojump/autojump.fish ]; and source #{OSPACK_PREFIX}/share/autojump/autojump.fish
