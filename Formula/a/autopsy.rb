class Autopsy < Formula
  ...
  # Installs prebuilt binaries, broken on arm: https://github.com/ospack/core/issues/175053
  ...
  # fixes weird configure script that wouldn't work nicely with ospack
  patch :DATA

  def autcfg
    # Although these binaries are usually available on Linux, they can be in different locations
    # so we use the ospacked versions instead.
    ...
    <<~EOS
      ...
      # Ospack users can install NSRL database and change this variable later
      $NSRLDB = '';
