class Podman < Formula
  ...
  # https://github.com/ospack/core/pull/205162#issuecomment-2607793814
  livecheck do
    url :stable
  ...
  test do
    ...
    if OS.mac?
      ...
      # See https://github.com/ospack/core/pull/166471
      out = shell_output("#{bin}/podman-remote machine init ospack-testvm")
      assert_match "Machine init complete", out
      system bin/"podman-remote", "machine", "rm", "-f", "ospack-testvm"
    else
