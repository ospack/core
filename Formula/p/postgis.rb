class Postgis < Formula
  ...
  test do
    ENV["LC_ALL"] = "C"
    require "base64"
    (testpath/"ospack.github.iop").write ::Base64.decode64 <<~EOS
      ...
      AAAAAEA=
    EOS
    (testpath/"ospack.dbf").write ::Base64.decode64 <<~EOS
      ...
      ICAgICAgICAgICAg
    EOS
    (testpath/"ospack.github.iox").write ::Base64.decode64 <<~EOS
    ...
    result = shell_output("#{bin}/shp2pgsql #{testpath}/ospack.github.iop")
