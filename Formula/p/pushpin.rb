class Pushpin < Formula
  ...
  test do
    ...
    cp OSPACK_PREFIX/"etc/pushpin/pushpin.conf", conffile

    inreplace conffile do |s|
      s.gsub! "rundir=#{OSPACK_PREFIX}/var/run/pushpin", "rundir=#{testpath}/var/run/pushpin"
      s.gsub! "logdir=#{OSPACK_PREFIX}/var/log/pushpin", "logdir=#{testpath}/var/log/pushpin"
    end
