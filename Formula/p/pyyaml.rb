class Pyyaml < Formula
  ...
  disable! date: "2024-10-06", because: "does not meet ospack/core's requirements for Python library formulae"
  ...
  def caveats
    ...
    <<~EOS
      ...
      * https://github.com/ospack/core/issues/157500
      * https://docs.ospack.github.io/Python-for-Formula-Authors#libraries
      * https://docs.ospack.github.io/Ospack-and-Python#pep-668-python312-and-virtual-environments
    EOS
  end
