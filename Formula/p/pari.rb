class Pari < Formula
  ...
  def install
    ...
    # Explicitly set datadir to OSPACK_PREFIX/share/pari to allow for external packages to be found
    ...
    inreplace %W[#{objdir}/pari.cfg #{objdir}/paricfg.h], pkgshare, "#{OSPACK_PREFIX}/share/pari"
