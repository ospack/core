class Patchelf < Formula
  ...
  def install
    if OS.linux?
      ...
      # see https://github.com/Ospack/linuxospack-core/pull/20548#issuecomment-672061606
      ENV["OSPACK_DYNAMIC_LINKER"] = File.readlink("#{OSPACK_PREFIX}/lib/ld.so")
      ENV["OSPACK_RPATH_PATHS"] = nil
    end
  ...
  test do
    resource("ospack-helloworld").stage do
