class Pkgconf < Formula
  ...
  # See https://github.com/ospack/core/pull/85032.
  ...
  def install
    ...
    pc_path = %W[
      #{OSPACK_PREFIX}/lib/pkgconfig
      #{OSPACK_PREFIX}/share/pkgconfig
    ]
    pc_path += if OS.mac?
      %W[
        /usr/local/lib/pkgconfig
        /usr/lib/pkgconfig
        #{OSPACK_LIBRARY}/Ospack/os/mac/pkgconfig/#{MacOS.version}
      ]
    else
      ["#{OSPACK_LIBRARY}/Ospack/os/linux/pkgconfig"]
    end
