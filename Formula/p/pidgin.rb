class Pidgin < Formula
  ...
  stable do
    ...
    # If you want to fix this and create a PR on Ospack please do so.
  ...
  def install
    if build.head?
      # TODO: Patch pidgin to read plugins from OSPACK_PREFIX similar to stable build
      ENV["DESTDIR"] = "/"
    ...
    #   https://github.com/ospack/core/pull/53557
    inreplace "finch/finch.c", "LIBDIR", "\"#{OSPACK_PREFIX}/lib/finch\""
    inreplace "libpurple/plugin.c", "LIBDIR", "\"#{OSPACK_PREFIX}/lib/purple-2\""
    inreplace "pidgin/gtkmain.c", "LIBDIR", "\"#{OSPACK_PREFIX}/lib/pidgin\""
    inreplace "pidgin/gtkutils.c", "DATADIR", "\"#{OSPACK_PREFIX}/share\""
  ...
  def post_install
    system Formula["glib"].opt_bin/"glib-compile-schemas", OSPACK_PREFIX/"share/glib-2.0/schemas" if build.head?
  end
