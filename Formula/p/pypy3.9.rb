class Pypy39 < Formula
  ...
  def install
    ...
    # Also create symlinks inside pkgshare to allow `ospack link/unlink` to work.
  ...
  def post_install
    ...
    # If `ospack link` created a symlink for scripts folder, replace it with a directory
