class PythonAT310 < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/a1618a5005d0b01d63b720321806820a03432f1a/python/3.10-sysconfig.diff"
  ...
  def sitecustomize
    <<~PYTHON
      ...
      tkinter_prefix = "#{OSPACK_PREFIX}/opt/python-tk@#{version.major_minor}/libexec"
