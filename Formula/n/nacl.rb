class Nacl < Formula
  ...
  def install
    ...
    inreplace "do" do |s|
      ...
      s.gsub!(/^shorthostname=`.*$/, "shorthostname=ospack")
    end
    ...
    include.install Dir["build/ospack/include/#{archstr}/crypto_*.h"]
    include.install "build/ospack/include/#{archstr}/randombytes.h"
    ...
    # know this.
    nacl_libdir = "build/ospack/lib/#{archstr}"
