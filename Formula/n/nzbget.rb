class Nzbget < Formula
  ...
  service do
    run [opt_bin/"nzbget", "-c", OSPACK_PREFIX/"etc/nzbget.conf", "-s", "-o", "OutputMode=Log",
         "-o", "ConfigTemplate=#{OSPACK_PREFIX}/share/nzbget/nzbget.conf",
         "-o", "WebDir=#{OSPACK_PREFIX}/share/nzbget/webui"]
    keep_alive true
    environment_variables PATH: "#{OSPACK_PREFIX}/bin:/usr/bin:/bin:/usr/sbin:/sbin"
  end
