class Sapling < Formula
  ...
  # see discussions in https://github.com/ospack/core/pull/197727
  ...
  def install
    ...
    inreplace "eden/scm/distutils_rust/__init__.py", '"OSPACK_CCCFG"', '"NONEXISTENT"'
    system "make", "-C", "eden/scm", "install-oss", "PREFIX=#{prefix}", "PYTHON=#{python3}", "PYTHON3=#{python3}"
  end

  def check_binary_linkage(binary, library)
    binary.dynamically_linked_libraries.any? do |dll|
      next false unless dll.start_with?(OSPACK_PREFIX.to_s)
