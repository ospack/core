class Sile < Formula
  ...
  # Ref: https://github.com/ospack/core/pull/128136#issuecomment-1505583956
  ...
  def caveats
    <<~EOS
      ...
      Ospack does not supply any of these font dependencies in default casks, but they can be added by tapping cask-fonts:
        ospack tap ospack/cask-fonts
        ospack install --cask font-gentium-plus
        ospack install --cask font-libertinus
        ospack install --cask font-hack
