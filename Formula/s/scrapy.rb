class Scrapy < Formula
  ...
  test do
    ...
    system bin/"scrapy", "startproject", "ospackproject"
    cd testpath/"ospackproject" do
      system bin/"scrapy", "genspider", "-t", "basic", "ospackspider", "ospack.github.io"
      assert_match "INFO: Spider closed (finished)", shell_output("#{bin}/scrapy crawl ospackspider 2>&1")
    end
  end
end
