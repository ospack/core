class SpectralCli < Formula
  ...
  test do
    resource "ospack-petstore.yaml" do
    ...
    resource "ospack-streetlights-mqtt.yml" do
    ...
    testpath.install resource("ospack-petstore.yaml")
    ...
    testpath.install resource("ospack-streetlights-mqtt.yml")
