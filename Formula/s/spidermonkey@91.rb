class SpidermonkeyAT91 < Formula
  ...
  # Can uncomment after https://github.com/ospack/core/pull/192986
  # as existing bottles are linked to ICU4C 74 like
  # #{OSPACK_PREFIX}/opt/icu4c/lib/libicudata.74.dylib
  ...
  def install
    ...
    # Avoid installing into OSPACK_PREFIX.
    # https://github.com/ospack/core/pull/98809
