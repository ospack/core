class SvtAv1 < Formula
  ...
  def install
    ...
    # are stripped by ospack's compiler shim. The M1 chip does not support the
  ...
  test do
    resource "ospack-testvideo" do
      url "https://github.com/grusell/svt-av1-ospack-testdata/raw/main/video_64x64_yuv420p_25frames.yuv"
      sha256 "0c5cc90b079d0d9c1ded1376357d23a9782a704a83e01731f50ccd162e246492"
    end

    testpath.install resource("ospack-testvideo")
