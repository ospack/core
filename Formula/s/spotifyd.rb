class Spotifyd < Formula
  ...
  stable do
    ...
    patch do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/7cb21d6370a1eae320f06a4f9150111db0bbf952/spotifyd/rust-1.80.patch"
  ...
  test do
    cmd = "#{bin}/spotifyd --username ospack_fake_user_for_testing \
      --password ospack --no-daemon --backend portaudio"
