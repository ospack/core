class SdlImage < Formula
  ...
  stable do
    ...
    # https://github.com/Ospack/ospack-python/issues/281
    # https://trac.macports.org/ticket/37453
    patch :p0 do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/41996822/sdl_image/IMG_ImageIO.m.patch"
  ...
  def install
    inreplace "SDL_image.pc.in", "@prefix@", OSPACK_PREFIX
