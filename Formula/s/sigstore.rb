class Sigstore < Formula
  ...
  test do
    ...
    resource "ospack-test-artifact" do
    ...
    resource "ospack-test-artifact.sigstore" do
    ...
    resource("ospack-test-artifact").stage testpath
    resource("ospack-test-artifact.sigstore").stage testpath
