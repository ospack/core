  ...
  test do
    ...
    (testpath/"bookmarks.html").write <<~HTML
      ...
      <DL><p>
          ...
          <DL><p>
              <DT><A HREF="https://github.com/Ospack/ospack" ADD_DATE="1477369518" LAST_MODIFIED="1477369529">Title unknown</A>
          </DL><p>
      </DL>
    HTML
    ...
    assert_equal <<~EOS, shell_output("#{bin}/buku --nostdin --nc --print").chomp
      1. Title unknown
         > https://github.com/Ospack/ospack
         # bookmarks toolbar
    EOS
    ...
    result = shell_output("#{bin}/buku --np --sany Ospack")
    assert_match "https://github.com/Ospack/ospack", result
