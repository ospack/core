class OspackCaskCompletion < Formula
  desc "Fish completion for ospack-cask"
  homepage "https://github.com/xyb/ospack-cask-completion"
  url "https://github.com/xyb/ospack-cask-completion/archive/refs/tags/v2.1.tar.gz"
  sha256 "27c7ea3b7f7c060f5b5676a419220c4ce6ebf384237e859a61c346f61c8f7a1b"
  license "BSD-2-Clause"
  revision 1
  head "https://github.com/xyb/ospack-cask-completion.git", branch: "master"
  ...
  def install
    fish_completion.install "ospack-cask.fish"
  end

  test do
    assert_predicate fish_completion/"ospack-cask.fish", :exist?
  end
end
