class Batt < Formula
  ...
  def install
    ...
    # Limit config path to Ospack prefix.
    ...
    # GOTAGS is set to disable built-in install/uninstall commands when building for Ospack.
    system "make", "GOTAGS=ospack", "VERSION=v#{version}"
