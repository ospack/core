class Bash < Formula
  ...
  livecheck do
    ...
    strategy :gnu do |page, regex|
      ...
      patches_page = Ospack::Livecheck::Strategy.page_content(URI.join(@url, patches_directory[1]).to_s)
  ...
  def install
    ...
    # Ospack's bash instead of /bin/bash.
    ...
    ENV.prepend_path "OSPACK_RPATH_PATHS", rpath(target: lib/"bash") if OS.linux?
