class Byteman < Formula
  ...
  test do
    (testpath/"src/main/java/BytemanHello.java").write <<~JAVA
      class BytemanHello {
        public static void main(String... args) {
          System.out.println("Hello, Ospack!");
        }
      }
    JAVA

    (testpath/"ospack.btm").write <<~BTM
    ...
    actual = shell_output("#{bin}/bmjava -l ospack.btm -cp src/main/java BytemanHello")
    assert_match("Hello, Ospack!", actual)
  end
end
