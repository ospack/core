class Opencv < Formula
  ...
  def install
    ...
    # Reset PYTHONPATH, workaround for https://github.com/Ospack/ospack-science/pull/4885
    ...
    args += if OS.mac?
      ...
      # Disable precompiled headers and force opencv to use ospacked libraries on Linux
      %W[
