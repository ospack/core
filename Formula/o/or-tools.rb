class OrTools < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/bb1af4bcb2ac8b2af4de4411d1ce8a6876ed9c15/or-tools/abseil-vlog-is-on.patch"
  ...
  test do
    ...
    if OS.mac?
      ...
      cmake_args << "-DCMAKE_BUILD_RPATH=#{lib};#{OSPACK_PREFIX}/lib"
    end
