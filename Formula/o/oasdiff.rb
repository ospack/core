class Oasdiff < Formula
  ...
  test do
    resource "ospack-openapi-test1.yaml" do
    ...
    resource "ospack-openapi-test5.yaml" do
    ...
    testpath.install resource("ospack-openapi-test1.yaml")
    testpath.install resource("ospack-openapi-test5.yaml")
