class OpenaiWhisper < Formula
  ...
  def install
    ...
    (venv.site_packages/"ospack-pytorch.pth").write pth_contents
  ...
  test do
    ...
    testpath.install resource("ospack-test-audio")
    (testpath/"models").install resource("ospack-test-model")
