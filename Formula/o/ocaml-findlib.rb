class OcamlFindlib < Formula
  ...
  def install
    # Specify OSPACK_PREFIX here so those are the values baked into the compile,
    # rather than the Cellar
    system "./configure", "-bindir", bin,
                          "-mandir", man,
                          "-sitelib", OSPACK_PREFIX/"lib/ocaml",
    ...
    # Save extra findlib.conf to work around https://github.com/Ospack/ospack-test-bot/issues/805
    libexec.mkpath
  ...
  test do
    ...
    assert_equal "#{OSPACK_PREFIX}/lib/ocaml/findlib", output.chomp
  end
end
