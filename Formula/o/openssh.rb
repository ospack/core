class Openssh < Formula
  ...
  on_macos do
    ...
    patch do
      url "https://raw.githubusercontent.com/Ospack/patches/1860b0a745f1fe726900974845d1b0dd3c3398d6/openssh/patch-sandbox-darwin.c-apple-sandbox-named-external.diff"
      sha256 "d886b98f99fd27e3157b02b5b57f3fb49f43fd33806195970d4567f12be66e71"
    end

    # https://github.com/apple-oss-distributions/OpenSSH/blob/main/openssh/sshd.c#L532
    patch do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/aa6c71920318f97370d74f2303d6aea387fb68e4/openssh/patch-sshd.c-apple-sandbox-named-external.diff"
  ...
  def install
    if OS.mac?
      ...
      # Also can segfault at runtime: https://github.com/ospack/core/issues/135200
  ...
  test do
    (etc/"ssh").find do |pn|
      ...
      refute_match OSPACK_CELLAR.to_s, pn.read
    end
