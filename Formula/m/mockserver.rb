class Mockserver < Formula
  ...
  url "https://search.maven.org/remotecontent?filepath=org/mock-server/mockserver-netty/5.15.0/mockserver-netty-5.15.0-ospack-tar.tar"
  ...
  def install
    inreplace "bin/run_mockserver.sh", "/usr/local", OSPACK_PREFIX
    libexec.install Dir["*"]
