class Movgrab < Formula
  ...
  patch do
    url "https://github.com/Ospack/formula-patches/raw/936597e74d22ab8cf421bcc9c3a936cdae0f0d96/movgrab/libUseful_xattr_backport.diff"
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/6e5fdfd05ce62383c7f3ac4b23ba31f5ffbac5b2/movgrab/linker.patch"
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/ba252015727b6f0fb362fec3edfb7c53a3f888c2/movgrab/pointer-conv.patch"
