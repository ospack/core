...
# out.
#
# To reduce Ospack's maintenance burden, patches are not accepted
# for this formula. The NeoMutt project has a Ospack tap for their
# patched version of Mutt: https://github.com/neomutt/ospack-neomutt
...
class Mutt < Formula
  ...
  def install
    ...
    # that isn't `mail`.
    # https://github.com/Ospack/ospack/issues/45400
