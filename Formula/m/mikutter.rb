class Mikutter < Formula
  ...
  url "https://mikutter.hachune.net/bin/mikutter-5.1.0.tar.gz", using: :ospack_curl
  ...
  def install
    ...
    env = {
      ...
      GEM_HOME:              OSPACK_PREFIX/"lib/mikutter/vendor/ruby/#{ruby_series}.0",
      GTK_PATH:              OSPACK_PREFIX/"lib/gtk-2.0",
    }
    ...
    libexec.install_symlink OSPACK_PREFIX/"lib/mikutter/plugin"
  end
