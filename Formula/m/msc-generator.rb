class MscGenerator < Formula
  ...
  def install
    ...
    # Ospack uses shims to ensure that the project is built with a single compiler.
    ...
    # as the main compiler, and bypass ospack's compiler shim to force using clang++
    # for Objective-C++ sources. This workaround should be removed once ospack supports
