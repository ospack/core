class Morpheus < Formula
  ...
  def install
    ...
    if OS.mac?
      ...
      args << "-DOSPACK_FORMULA_DEPLOYMENT=ON"
    ...
    # Set PATH environment variable including Ospack prefix in macOS app bundle
    inreplace "#{prefix}/Morpheus.app/Contents/Info.plist", "OSPACK_BIN_PATH", "#{OSPACK_PREFIX}/bin"
  end
