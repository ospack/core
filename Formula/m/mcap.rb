class Mcap < Formula
  ...
  test do
    resource "ospack-testdata-OneMessage" do
    ...
    resource "ospack-testdata-OneAttachment" do
    ...
    resource "ospack-testdata-OneMetadata" do
