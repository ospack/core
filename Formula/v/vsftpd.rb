class Vsftpd < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/5fbea7b01a521f840f51be6ffec29f612a37eed3/vsftpd/3.0.3.patch"
  ...
  # GitHub)
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/e4dd5d67152bb2541c5e38e8bb834ed5b165fcaa/vsftpd/3.0.5.patch"
  ...
  def caveats
    <<~EOS
      ...
      The vsftpd.conf file must be owned by root or vsftpd will refuse to start:
        sudo chown root #{OSPACK_PREFIX}/etc/vsftpd.conf
    EOS
  end
