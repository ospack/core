class Vapoursynth < Formula
  ...
  def install
    ...
    system "./configure", "--disable-silent-rules",
                          ...
                          "--with-plugindir=#{OSPACK_PREFIX}/lib/vapoursynth",
  ...
  def caveats
    <<~EOS
      ...
      To use vapoursynth.core.sub, execute:
        ospack install vapoursynth-sub
      To use vapoursynth.core.ocr, execute:
        ospack install vapoursynth-ocr
      To use vapoursynth.core.imwri, execute:
        ospack install vapoursynth-imwri
      To use vapoursynth.core.ffms2, execute the following:
        ospack install ffms2
        ln -s "../libffms2.dylib" "#{OSPACK_PREFIX}/lib/vapoursynth/#{shared_library("libffms2")}"
