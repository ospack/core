class Varnish < Formula
  ...
  def install
    ...
    # pointing to the ${OSPACK_PREFIX}/ shared structure so other packages
    # can install VMODs and VCL.
    ENV.append_to_cflags "-DVARNISH_VMOD_DIR='\"#{OSPACK_PREFIX}/lib/varnish/vmods\"'"
    ENV.append_to_cflags "-DVARNISH_VCL_DIR='\"#{pkgetc}:#{OSPACK_PREFIX}/share/varnish/vcl\"'"
