class John < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/cd039571f9a3e9ecabbe68bdfb443e3abaae6270/john/1.9.0.patch"
  ...
  test do
    (testpath/"passwd").write <<~EOS
      root:$1$ospack$dOoH2.7QsPufgT8T.pihw/:0:0:System Administrator:/var/root:/bin/sh
    EOS
