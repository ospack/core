class Jnethack < Formula
  ...
  def install
    ...
    inreplace "sys/unix/hints/#{platform}" do |s|
      ...
      s.gsub! replace_string, "CFLAGS+=-DVAR_PLAYGROUND='\"#{OSPACK_PREFIX}/share/jnethack\"'"
    end
  ...
  def post_install
    ...
    savedir = OSPACK_PREFIX/"share/jnethack"
    mkdir_p savedir
    cd savedir do
  ...
  test do
    ...
    assert_match (OSPACK_PREFIX/"share/jnethack").to_s,
