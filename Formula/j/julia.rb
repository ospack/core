class Julia < Formula
  ...
  test do
    ...
    # https://github.com/orgs/Ospack/discussions/2749
    system bin/"julia", *args, "--eval", 'using Pkg; Pkg.add("Example")'

    # Check that Julia can load stdlibs that load non-Julia code.
    # Most of these also check that Julia can load Ospack-provided libraries.
    jlls = %w[
    ...
    # Most of these are symlinks to Ospack-provided libraries.
