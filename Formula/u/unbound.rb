class Unbound < Formula
  ...
  def install
    ...
    inreplace "doc/example.conf", 'username: "unbound"', 'username: "@@OSPACK-UNBOUND-USER@@"'
    system "make"
    system "make", "install"
  end
  ...
  def post_install
    ...
    return unless conf.read.include?('username: "@@OSPACK-UNBOUND-USER@@"')

    inreplace conf, 'username: "@@OSPACK-UNBOUND-USER@@"',
                    "username: \"#{ENV["USER"]}\""
  end
