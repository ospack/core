class Lua < Formula
  ...
  # See: https://github.com/Ospack/legacy-ospack/pull/5043
  patch do
    on_macos do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/11c8360432f471f74a9b2d76e012e3b36f30b871/lua/lua-dylib.patch"
    ...
    on_linux do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/0dcd11880c7d63eb395105a5cdddc1ca05b40f4a/lua/lua-so.patch"
  ...
  def install
    ...
    inreplace "src/luaconf.h", "/usr/local", OSPACK_PREFIX
  ...
  def caveats
    <<~EOS
      You may also want luarocks:
        ospack install luarocks
    EOS
  end

  test do
    assert_match "Ospack is awesome!", shell_output("#{bin}/lua -e \"print ('Ospack is awesome!')\"")
  end
end
