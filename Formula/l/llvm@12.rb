class LlvmAT12 < Formula
  ...
  # See: Ospack/ospack-core/issues/35513
  ...
  on_linux do
    ...
    patch do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/f0b8ff8b7ad4c2e1d474b214cd615a98e0caa796/llvm/llvm.patch"
  ...
  # https://github.com/ospack/core/issues/84365
  patch do
