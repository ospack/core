class Lanraragi < Formula
  ...
  def install
    ...
    # Modify Archive::Libarchive to help find ospack `libarchive`. Although environment
    ...
    libexec.install "tools/build/ospack/redis.conf"
    bin.install "tools/build/ospack/lanraragi"
  end
  ...
  test do
    ...
    # This can't have its _user-facing_ functionality tested in the `ospack test`
