class Lizard < Formula
  ...
  test do
    (testpath/"tests/test.txt").write <<~EOS
      Ospack is a free and open-source software package management system that simplifies the installation
      ...
      Ruby on Rails community and earned praise for its extensibility. Ospack has been recommended for its
      ease of use as well as its integration into the command line. Ospack is a non-profit project member
