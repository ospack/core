class Latexml < Formula
  ...
  # Ref: https://github.com/ospack/core/pull/94387
  depends_on "perl"
  ...
  # The remaining perl resources are needed when using Ospack perl,
  ...
  test do
    (testpath/"test.tex").write <<~'TEX'
      ...
      \title{LaTeXML Ospack Test}
      \begin{document}
      \maketitle
      \end{document}
    TEX
    assert_match %r{<title>LaTeXML Ospack Test</title>},
