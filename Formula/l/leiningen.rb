class Leiningen < Formula
  ...
  test do
    (testpath/"project.clj").write <<~CLOJURE
      (defproject ospack-test "1.0"
        :dependencies [[org.clojure/clojure "1.10.3"]])
    CLOJURE

    (testpath/"src/ospack_test/core.clj").write <<~CLOJURE
      (ns ospack-test.core)
      (defn adds-two
    ...
    (testpath/"test/ospack_test/core_test.clj").write <<~CLOJURE
      (ns ospack-test.core-test
        (:require [clojure.test :refer :all]
                  [ospack-test.core :as t]))
      (deftest canary-test
