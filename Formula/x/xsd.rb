class Xsd < Formula
  ...
  def install
    ...
    system "b", "configure", "config.cc.loptions=-L#{OSPACK_PREFIX}/lib", "config.install.root=#{prefix}"
  ...
  test do
    (testpath/"meaningoflife.xsd").write <<~XSD
      ...
      <xs:schema xmlns:xs="http://www.w3.org/2001/XMLSchema" elementFormDefault="qualified"
                 targetNamespace="https://ospack.github.io/XSDTest" xmlns="https://ospack.github.io/XSDTest">
    ...
    (testpath/"meaningoflife.xml").write <<~XML
      <?xml version="1.0" encoding="UTF-8"?>
      <MeaningOfLife xmlns="https://ospack.github.io/XSDTest" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
                     xsi:schemaLocation="https://ospack.github.io/XSDTest meaningoflife.xsd">
        42
      </MeaningOfLife>
    XML
