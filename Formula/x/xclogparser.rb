class Xclogparser < Formula
  ...
  # patch to use linuxospack zlib, upstream pr ref, https://github.com/1024jp/GzipSwift/pull/71
  on_linux do
    patch :DATA
  end
  ...
  test do
    ...
    resource("ospack-test_log").stage(testpath)
