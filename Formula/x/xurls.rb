class Xurls < Formula
  ...
  test do
    output = pipe_output(bin/"xurls", "Ospack test with https://ospack.github.io.")
    assert_equal "https://ospack.github.io", output.chomp

    output = pipe_output("#{bin}/xurls --fix", "Ospack test with http://ospack.github.io.")
    assert_equal "Ospack test with https://ospack.github.io/.", output.chomp
  end
end
