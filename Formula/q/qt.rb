class Qt < Formula
  ...
  def install
    ...
    # It is not friendly to Ospack or macOS
    ...
    cmake_args = std_cmake_args(install_prefix: OSPACK_PREFIX, find_framework: "FIRST") + %w[
    ...
    cmake_args += if OS.mac?
      ...
      # that cmake does not think $OSPACK_PREFIX/lib is the install prefix.
      #
    ...
    qtversion_xml.write <<~XML
      ...
      <data>
        ...
        <value type="QString" key="Name">Qt %{Qt:Version} (#{OSPACK_PREFIX})</value>
    ...
    # i.e. there is no upstream or Ospack support.
  ...
  test do
    ...
    ENV["QT_QPA_PLATFORM"] = "minimal" if OS.linux? && ENV["OSPACK_GITHUB_ACTIONS"]
