class Qemu < Formula
  ...
  def install
    ...
    # silent runtime failures, so we set it to a Ospack path in order to
    # obtain sensible runtime errors. This will also be compatible with
    # Samba installations from external taps.
    args << "--smbd=#{OSPACK_PREFIX}/sbin/samba-dot-org-smbd"
  ...
  test do
    ...
    resource("ospack-test-image").stage testpath
