class KimApi < Formula
  ...
  url "https://s3.openkim.org/kim-api/kim-api-2.3.0.txz", using: :ospack_curl
  ...
  def install
    args = [
      ...
      "-DKIM_API_SYSTEM_MODEL_DRIVERS_DIR=:#{OSPACK_PREFIX}/lib/openkim-models/model-drivers",
      "-DKIM_API_SYSTEM_PORTABLE_MODELS_DIR=:#{OSPACK_PREFIX}/lib/openkim-models/portable-models",
      "-DKIM_API_SYSTEM_SIMULATOR_MODELS_DIR=:#{OSPACK_PREFIX}/lib/openkim-models/simulator-models",
