class KyotoTycoon < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/955ce09/kyoto-tycoon/0.9.56.patch"
    sha256 "7a5efe02a38e3f5c96fd5faa81d91bdd2c1d2ffeb8c3af52878af4a2eab3d830"
  end

  # Ospack-specific patch to support testing with ephemeral ports (submitted upstream)
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/9925c07/kyoto-tycoon/ephemeral-ports.patch"
  ...
  test do
    ...
    assert_match "Ospack\tCool", shell_output("#{bin}/ktremotemgr script -port #{port} echo Ospack Cool 2>&1")
  end
end
