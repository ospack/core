class Harbour < Formula
  ...
  def install
    ...
    # The vendored version of liblzf is used instead of the Ospack one because the Ospack version
    ...
    # the Ospack version of libmxml.
    # The vendored version of minilzo is used because the Ospack version of lzo does not include minilzo.
