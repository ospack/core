class Helmify < Formula
  ...
  test do
    ...
    system "cat #{test_service} | #{bin}/helmify ospacktest"
    assert_predicate testpath/"ospacktest/Chart.yaml", :exist?
    assert_equal expected_values_yaml, (testpath/"ospacktest/values.yaml").read
