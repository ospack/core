class Httpie < Formula
  ...
  def install
    ...
    File.write("httpie/internal/__build_channel__.py", "BUILD_CHANNEL = \"ospack\"")
  ...
  test do
    ...
    raw_url = "https://raw.githubusercontent.com/Ospack/ospack-core/HEAD/Formula/h/httpie.rb"
