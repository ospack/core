class Httpd < Formula
  ...
  def install
    ...
    # remove non-executable files in bin dir (for ospack audit)
    rm bin/"envvars"
    rm bin/"envvars-std"
    ...
    inreplace %W[
      ...
      s.gsub! lib/"httpd/modules", OSPACK_PREFIX/"lib/httpd/modules"
    end
    ...
    inreplace "#{lib}/httpd/build/config_vars.mk" do |s|
      ...
      s.gsub! "${prefix}/lib/httpd/modules", OSPACK_PREFIX/"lib/httpd/modules"
      s.gsub! Superenv.shims_path, OSPACK_PREFIX/"bin"
    end
  end
