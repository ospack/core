  ...
  def caveats
    <<~EOS
      ...
      For bash, add the following command to your .bashrc:
        eval "$(test -x $(ospack --prefix)/bin/hermit && $(ospack --prefix)/bin/hermit shell-hooks --print --bash)"

      For zsh, add the following command to your .zshrc:
        eval "$(test -x $(ospack --prefix)/bin/hermit && $(ospack --prefix)/bin/hermit shell-hooks --print --zsh)"
    EOS
  end
