class ElanInit < Formula
  ...
  stable do
    ...
    patch do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/815affb24bff77daad4e99e31afed8de42a31312/elan-init/rust-1.80.patch"
  ...
  def install
    ENV["RELEASE_TARGET_NAME"] = "ospack-build"
