class Exim < Formula
  ...
  livecheck do
    ...
    strategy :page_match do |page, regex|
      ...
      fixes_page = Ospack::Livecheck::Strategy.page_content(URI.join(@url, "fixes").to_s)
  ...
  def install
    ...
    open("Local/Makefile", "a") do |s|
      ...
      # For non-/usr/local OSPACK_PREFIX
      s << "LOOKUP_INCLUDE=-I#{OSPACK_PREFIX}/include\n"
      s << "LOOKUP_LIBS=-L#{OSPACK_PREFIX}/lib\n"
    end
