class Libbi < Formula
  ...
  def install
    ...
    # make Ospack packages discoverable for compilation/linking
    inreplace "share/configure.ac" do |s|
      cppflags = s.get_make_var("CPPFLAGS").delete('"')
      ldflags = s.get_make_var("LDFLAGS").delete('"')
      s.change_make_var! "CPPFLAGS", "\"#{cppflags} -I#{OSPACK_PREFIX}/include\""
      s.change_make_var! "LDFLAGS", "\"#{ldflags} -L#{OSPACK_PREFIX}/lib\""
    end
    ...
    # See, e.g., https://github.com/ospack/core/issues/4936
