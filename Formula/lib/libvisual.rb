class Libvisual < Formula
  ...
  def install
    ...
    #       so we rely on ospack's auto-symlinking to
    #       <OSPACK_PREFIX>/lib/libvisual-<major>.<minor> .
    ...
    inreplace "configure",
      ...
      "LIBVISUAL_PLUGINS_BASE_DIR=\"#{OSPACK_PREFIX}/lib/libvisual-#{version.major_minor}\""
