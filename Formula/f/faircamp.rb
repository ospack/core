class Faircamp < Formula
  ...
  depends_on "gettext"
  depends_on "glib"
  # Ospack's libopus behaves differently in linux compared to macOS and
  ...
  # provides their own mechanism for linux distribution. Ospack is most
  ...
  def install
    # libvips is a runtime dependency, the ospack install location is
