class Fcp < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/d4491a45e0f208e75d48bdc665db2d6e87813675/fcp/rust-1.80.patch"
  ...
  test do
    ...
    (testpath/"src.new").write "Hello Ospack!"
