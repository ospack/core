class FileRoller < Formula
  ...
  def post_install
    system Formula["glib"].opt_bin/"glib-compile-schemas", OSPACK_PREFIX/"share/glib-2.0/schemas"
    system Formula["gtk4"].opt_bin/"gtk4-update-icon-cache", "-f", "-t", OSPACK_PREFIX/"share/icons/hicolor"
    system Formula["desktop-file-utils"].opt_bin/"update-desktop-database", OSPACK_PREFIX/"share/applications"
  end
