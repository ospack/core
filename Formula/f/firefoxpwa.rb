class Firefoxpwa < Formula
  ...
  def install
    ...
    # Prepare the project to work with Ospack
    ENV["FFPWA_EXECUTABLES"] = opt_bin
    ENV["FFPWA_SYSDATA"] = opt_share
    system "bash", "./packages/ospack/configure.sh", version.to_s, opt_bin, opt_libexec
    ...
    share.install "manifests/ospack.json" => "firefoxpwa.json"
