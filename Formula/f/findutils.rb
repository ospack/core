class Findutils < Formula
  ...
  test do
    touch "OSPACK"
    if OS.mac?
      assert_match "OSPACK", shell_output("#{bin}/gfind .")
      assert_match "OSPACK", shell_output("#{opt_libexec}/gnubin/find .")
    else
      assert_match "OSPACK", shell_output("#{bin}/find .")
    end
  end
end
