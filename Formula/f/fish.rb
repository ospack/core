class Fish < Formula
  ...
  def install
    system "cmake", "-S", ".", "-B", "build", *std_cmake_args,
                    ...
                    "-Dextra_functionsdir=#{OSPACK_PREFIX}/share/fish/vendor_functions.d",
                    "-Dextra_completionsdir=#{OSPACK_PREFIX}/share/fish/vendor_completions.d",
                    "-Dextra_confdir=#{OSPACK_PREFIX}/share/fish/vendor_conf.d"
