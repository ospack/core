class Flexiblas < Formula
  ...
  def install
    ...
    # Add OSPACK_PREFIX path to default searchpath to allow detecting separate formulae
    inreplace "CMakeLists.txt",
              %r{(FLEXIBLAS_DEFAULT_LIB_PATH "\${CMAKE_INSTALL_FULL_LIBDIR}/\${flexiblasname}/)"},
              "\\1:#{OSPACK_PREFIX}/lib/${flexiblasname}\""
    ...
    # Let ospack manage linking/deleting config files that are intended to be read-only
