class Fontforge < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/9403988/fontforge/20230101.patch"
  ...
  def caveats
    on_macos do
      <<~TEXT
        ...
        Alternatively, install with Ospack Cask:
          ospack install --cask fontforge
      TEXT
    end
  end

  test do
    resource "ospack-testdata" do
    ...
    resource("ospack-testdata").stage do
