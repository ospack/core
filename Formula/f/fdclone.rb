class Fdclone < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/86107cf/fdclone/3.01b.patch"
  ...
  test do
    assert_match "Hello Ospack", shell_output("#{bin}/fdsh -c \"echo Hello Ospack\"")
  end
end
