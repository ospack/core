class Cgal < Formula
  ...
  def install
    ...
    # Ensure that the various `Find*` modules look in OSPACK_PREFIX.
    ...
    inreplace inreplace_files.map { |file| lib/"cmake/CGAL"/file }, "/usr/local", OSPACK_PREFIX
  ...
  test do
    ...
    system "cmake", "-L", "-DQt6_DIR=#{Formula["qt"].opt_lib}/cmake/Qt6",
           ...
           "-DCMAKE_BUILD_RPATH=#{OSPACK_PREFIX}/lib", "-DCMAKE_PREFIX_PATH=#{prefix}", "."
