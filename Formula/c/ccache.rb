class Ccache < Formula
  ...
  def install
    ...
    # Ospack compiler shim actively prevents ccache usage (see caveats), which will break the test suite.
    ...
    # See https://github.com/ospack/core/pull/83900#issuecomment-90624064
  ...
  def caveats
    <<~EOS
      ...
      ALSO NOTE: The ospack command, by design, will never use ccache.
    EOS
  end
  ...
  test do
    ...
    # https://github.com/orgs/Ospack/discussions/5830
