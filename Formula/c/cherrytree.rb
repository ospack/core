class Cherrytree < Formula
  ...
  test do
    ...
    (testpath/"ospack.ctd").write <<~XML
      ...
      <cherrytree>
        ...
        <node name="rich text" unique_id="1" prog_lang="custom-colors" tags="" readonly="0" custom_icon_id="0" is_bold="0" foreground="" ts_creation="1611952177" ts_lastsave="1611952932">
          ...
          <rich_text> </rich_text>
          <rich_text link="webs https://ospack.github.io/">ospack</rich_text>
        </node>
    ...
    system bin/"cherrytree", testpath/"ospack.ctd", "--export_to_txt_dir", testpath, "--export_single_file"
    assert_predicate testpath/"ospack.ctd.txt", :exist?
    assert_match "rich text", (testpath/"ospack.ctd.txt").read
    assert_match "this is a simple command line test for ospack", (testpath/"ospack.ctd.txt").read
    assert_match "code", (testpath/"ospack.ctd.txt").read
    assert_match "print('hello world')", (testpath/"ospack.ctd.txt").read
  end
end
