class Circleci < Formula
  ...
  def install
    ldflags = %W[
      -s -w
      -X github.com/CircleCI-Public/circleci-cli/version.packageManager=ospack
  ...
  test do
    ...
    assert_match "update is not available because this tool was installed using ospack.",
