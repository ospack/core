class Cryfs < Formula
  ...
  test do
    ...
    # Test mounting a filesystem. This command will ultimately fail because ospack tests
    ...
    # the cryfs bottle was compiled with and the crypto++ library installed by ospack to.
    mkdir "basedir"
    mkdir "mountdir"
