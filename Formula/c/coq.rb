class Coq < Formula
  ...
  def install
    # Work around for https://github.com/Ospack/ospack-test-bot/issues/805
    if ENV["OSPACK_GITHUB_ACTIONS"] && !(Formula["ocaml-findlib"].etc/"findlib.conf").exist?
    ...
    system "./configure", "-prefix", prefix,
                          "-mandir", man,
                          "-libdir", OSPACK_PREFIX/"lib/ocaml/coq",
  ...
  test do
    ...
    assert_equal "#{OSPACK_PREFIX}/lib/ocaml/coq-core/plugins/ltac", output.chomp
  end
end
