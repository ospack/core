...
class Cvs < Formula
  ...
  patch do
    ...
    on_macos do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/24118ec737c7d008420d4683a07129ed80a759eb/cvs/vasnprintf-high-sierra-fix.diff"
  ...
  test do
    ...
    mkdir "cvsexample" do
      ENV["CVSROOT"] = cvsroot
      system bin/"cvs", "import", "-m", "dir structure", "cvsexample", "ospack", "start"
    end
  end
end
