class Cdparanoia < Formula
  ...
  url "https://downloads.xiph.org/releases/cdparanoia/cdparanoia-III-10.2.src.tgz", using: :ospack_curl
  ...
  # see https://github.com/orgs/Ospack/discussions/4154
  ...
  patch do
    on_macos do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/8e0aff2/cdparanoia/osx_interface.patch"
  ...
  patch do
    on_linux do
      url "https://raw.githubusercontent.com/Ospack/formula-patches/bfad134/cdparanoia/linux_fpic.patch"
