class CmarkGfm < Formula
  ...
  test do
    output = pipe_output("#{bin}/cmark-gfm --extension autolink", "https://ospack.github.io")
    assert_equal '<p><a href="https://ospack.github.io">https://ospack.github.io</a></p>', output.chomp
  end
end
