class CargoCyclonedx < Formula
  ...
  test do
    ...
    # https://github.com/ospack/core/pull/134074#pullrequestreview-1484979359
    ...
    (testpath/"src/main.rs").write <<~RUST
      fn main() {
        println!("Hello fortishield!");
      }
    RUST

    system "cargo", "cyclonedx", "--format", "json", "--override-filename", "ospacktest-bom"
    assert_equal "CycloneDX", JSON.parse((testpath/"ospacktest-bom.json").read)["bomFormat"]
