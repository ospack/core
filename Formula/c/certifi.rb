class Certifi < Formula
  ...
  def install
    ...
    inreplace "README.rst", "/usr/local", OSPACK_PREFIX

    pythons.each do |python|
      python_exe = python.opt_libexec/"bin/python"
      system python_exe, "-m", "pip", "install", *std_pip_args(build_isolation: true), "."

      # Use ospacked ca-certificates PEM file instead of the bundled copy
    ...
    inreplace "README.rst", OSPACK_PREFIX, "/usr/local"
  end
