class InfluxdbAT1 < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/a2f5c7e20f69eabde99098e6480d2b29faaf2638/influxdb%401/1.11.8-rust.patch"
  ...
  service do
    run [opt_bin/"influxd", "-config", OSPACK_PREFIX/"etc/influxdb.conf"]
    keep_alive true
    working_dir var
