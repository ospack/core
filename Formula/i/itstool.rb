class Itstool < Formula
  ...
  def install
    ...
    # Check for itstool data files in OSPACK_PREFIX. This also ensures uniform bottles.
    inreplace libexec/"bin/itstool", "/usr/local", OSPACK_PREFIX
  end
  ...
  test do
    ...
    assert_match "msgid \"Ospack\"", File.read("test.pot")
  end
end
