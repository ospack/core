class Icecast < Formula
  ...
  url "https://downloads.xiph.org/releases/icecast/icecast-2.4.4.tar.gz", using: :ospack_curl
  ...
  def install
    ...
    # HACK: Avoid linking ospacked `curl` as side effect of `using: :ospack_curl`
