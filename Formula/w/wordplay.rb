class Wordplay < Formula
  ...
  patch :p0 do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/5de9072/wordplay/patch-wordplay.c"
  ...
  test do
    assert_equal "OSPACK", shell_output("#{bin}/wordplay -s ERWB").strip
  end
end
