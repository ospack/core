  ...
  def caveats
    <<~EOS
      To activate these completions, add the following to your .zshrc:
        ...
        if type ospack &>/dev/null; then
          FPATH=$(ospack --prefix)/share/zsh-completions:$FPATH
      ...
      to load these completions, you may need to run these commands:
        ...
        chmod go-w '#{OSPACK_PREFIX}/share'
        chmod -R go-w '#{OSPACK_PREFIX}/share/zsh'
    EOS
  end
