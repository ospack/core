class Zsh < Formula
  ...
  def install
    ...
    system "./configure", "--prefix=#{prefix}",
           ...
           "--enable-site-fndir=#{OSPACK_PREFIX}/share/zsh/site-functions",
           "--enable-site-scriptdir=#{OSPACK_PREFIX}/share/zsh/site-scripts",
    ...
    if build.head?
      # disable target install.man, because the required yodl comes neither with macOS nor Ospack
  ...
  test do
    assert_equal "ospack", shell_output("#{bin}/zsh -c 'echo ospack'").chomp
