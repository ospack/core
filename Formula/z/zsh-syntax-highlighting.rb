class ZshSyntaxHighlighting < Formula
  ...
  def install
    ...
    inreplace "highlighters/main/main-highlighter.zsh", "/usr/local/bin", "#{OSPACK_PREFIX}/bin"
  ...
  def caveats
    <<~EOS
      To activate the syntax highlighting, add the following at the end of your .zshrc:
        source #{OSPACK_PREFIX}/share/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh

      If you receive "highlighters directory not found" error message,
      you may need to add the following to your .zshenv:
        export ZSH_HIGHLIGHT_HIGHLIGHTERS_DIR=#{OSPACK_PREFIX}/share/zsh-syntax-highlighting/highlighters
    EOS
  end
