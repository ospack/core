class Guile < Formula
  ...
  def install
    ...
    ENV.append "LDFLAGS", "-Wl,-rpath,#{OSPACK_PREFIX}/lib"
    ...
    # Ospack automatically removing Cellar paths from .pc files in favour
  ...
  def post_install
    ...
    (OSPACK_PREFIX/"lib/guile/3.0/site-ccache").mkpath
    (OSPACK_PREFIX/"lib/guile/3.0/extensions").mkpath
    (OSPACK_PREFIX/"share/guile/site/3.0").mkpath
  end

  def caveats
    <<~EOS
      Guile libraries can now be installed here:
          Source files: #{OSPACK_PREFIX}/share/guile/site/3.0
        Compiled files: #{OSPACK_PREFIX}/lib/guile/3.0/site-ccache
            Extensions: #{OSPACK_PREFIX}/lib/guile/3.0/extensions

      Add the following to your .bashrc or equivalent:
        export GUILE_LOAD_PATH="#{OSPACK_PREFIX}/share/guile/site/3.0"
        export GUILE_LOAD_COMPILED_PATH="#{OSPACK_PREFIX}/lib/guile/3.0/site-ccache"
        export GUILE_SYSTEM_EXTENSIONS_PATH="#{OSPACK_PREFIX}/lib/guile/3.0/extensions"
    EOS
  end
