class GiDocgen < Formula
  ...
  test do
    (testpath/"ospack.toml").write <<~TOML
      [library]
      description = "Ospack gi-docgen formula test"
      authors = "Ospack"
      license = "BSD-2-Clause"
      browse_url = "https://github.com/Ospack/ospack"
      repository_url = "https://github.com/Ospack/ospack.git"
      website_url = "https://ospack.github.io/"
    TOML

    (testpath/"ospack.gir").write <<~EOS
      <?xml version="1.0"?>
      <repository version="1.2"
                  xmlns="http://www.gtk.org/introspection/core/1.0"
                  xmlns:c="http://www.gtk.org/introspection/c/1.0">
        <namespace name="ospack" version="1.0" c:identifier-prefixes="ospack" c:symbol-prefixes="ospack">
    ...
    output = shell_output("#{bin}/gi-docgen generate -C ospack.toml ospack.gir")
    assert_match "Creating namespace index file for ospack-1.0", output
    assert_predicate testpath/"ospack-1.0/index.html", :exist?
    assert_predicate testpath/"ospack-1.0/struct.Formula.html", :exist?
    assert_match %r{Website.*>https://ospack.github.io/}, (testpath/"ospack-1.0/index.html").read
    assert_match(/struct.*Formula.*{/, (testpath/"ospack-1.0/struct.Formula.html").read)
  end
end
