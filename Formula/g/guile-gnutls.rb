class GuileGnutls < Formula
  ...
  def post_install
    ...
    # See https://github.com/ospack/core/pull/60307#discussion_r478917491
  ...
  test do
    ...
    ENV["GUILE_LOAD_PATH"] = OSPACK_PREFIX/"share/guile/site/3.0"
    ENV["GUILE_LOAD_COMPILED_PATH"] = OSPACK_PREFIX/"lib/guile/3.0/site-ccache"
    ENV["GUILE_SYSTEM_EXTENSIONS_PATH"] = OSPACK_PREFIX/"lib/guile/3.0/extensions"
