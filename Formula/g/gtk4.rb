class Gtk4 < Formula
  ...
  def post_install
    ...
    system bin/"gtk4-update-icon-cache", "-f", "-t", "#{OSPACK_PREFIX}/share/icons/hicolor"
    system "#{Formula["glib"].opt_bin}/gio-querymodules", "#{OSPACK_PREFIX}/lib/gtk-4.0/4.0.0/printbackends"
  end
