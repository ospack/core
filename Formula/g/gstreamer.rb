class Gstreamer < Formula
  ...
  stable do
    ...
    resource "rs" do
      ...
      patch do
        url "https://raw.githubusercontent.com/Ospack/formula-patches/6fff2c4c62f1fb32b5ade46ec9246fc239935d7a/gstreamer/gst-plugins-rs-dav1d.patch"
  ...
  on_macos do
    ...
    # https://github.com/ospack/core/pull/92041
    depends_on "musepack"
  end
  ...
  test do
    ...
    #   https://github.com/orgs/Ospack/discussions/3740
    ...
    skip_plugins = OS.mac? && Hardware::CPU.intel? && ENV["OSPACK_GITHUB_ACTIONS"]
