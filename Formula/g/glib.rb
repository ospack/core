class Glib < Formula
  ...
  # replace several hardcoded paths with ospack counterparts
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/b46d8deae6983110b4e39bb2971bcbd10bb59716/glib/hardcoded-paths.diff"
  ...
  def install
    ...
    args = %W[
      --localstatedir=#{var}
      -Dgio_module_dir=#{OSPACK_PREFIX}/lib/gio/modules
    ...
    inreplace lib/"pkgconfig/gio-2.0.pc",
              "giomoduledir=#{OSPACK_PREFIX}/lib/gio/modules",
  ...
  def post_install
    (OSPACK_PREFIX/"lib/gio/modules").mkpath
  end
