...
class GlibcAT217 < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/41fdb9d5ec21fc8165cd4bee89bd23d0c90572ee/glibc/2.17-aarch64-dl-machine.diff"
  ...
  def install
    ...
    # Use ospacked ld.so.preload rather than the host's /etc/ld.so.preload
