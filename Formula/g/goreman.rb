class Goreman < Formula
  ...
  test do
    (testpath/"Procfile").write "web: echo 'hello' > goreman-ospack-test.out"
    system bin/"goreman", "start"
    assert_predicate testpath/"goreman-ospack-test.out", :exist?
    assert_match "hello", (testpath/"goreman-ospack-test.out").read
  end
end
