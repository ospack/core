class GccAT11 < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/5c9419923ddb3e5302ddd277bc524f4d4b0f8722/gcc/gcc-11.5.0.diff"
  ...
  def post_install
    if OS.linux?
      ...
      # For libraries:
      #   * `-nostdlib -L#{libgcc} -L#{glibc.opt_lib}` instructs gcc to use ospacked glibc
      #     if applied.
      ...
      libdir = OSPACK_PREFIX/"lib/gcc/#{version.major}"
