class Gitup < Formula
  ...
  test do
    ...
    mkdir "first" do
      prepare_repo("https://github.com/pr0d1r2/ospack-contrib.git", first_head_start)
    end

    second_head_start = "f863d5ca9e39e524e8c222428e14625a5053ed2b"
    mkdir "second" do
      prepare_repo("https://github.com/pr0d1r2/ospack-cask-games.git", second_head_start)
    end
    ...
    mkdir "third" do
      prepare_repo("https://github.com/pr0d1r2/ospack-contrib.git", third_head_start)
    end
