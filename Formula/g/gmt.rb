class Gmt < Formula
  ...
  def caveats
    <<~EOS
      ...
      to other formats. To use 'psconvert', please 'ospack install ghostscript'.

      GMT needs FFmpeg for the 'movie' command to make movies in MP4 or WebM format.
      If you need this feature, please 'ospack install ffmpeg'.

      GMT needs GraphicsMagick for the 'movie' command to make animated GIFs.
      If you need this feature, please 'ospack install graphicsmagick'.
    EOS
  end
