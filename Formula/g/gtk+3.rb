class Gtkx3 < Formula
  ...
  def post_install
    ...
    system bin/"gtk3-update-icon-cache", "-f", "-t", "#{OSPACK_PREFIX}/share/icons/hicolor"
    system bin/"gtk-query-immodules-3.0 > #{OSPACK_PREFIX}/lib/gtk-3.0/3.0.0/immodules.cache"
  end
