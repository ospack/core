class Docbook2x < Formula
  ...
  test do
    ...
    (testpath/"ospack.1.xml").write <<~XML
      <?xml version="1.0" encoding="ISO-8859-1"?>
      <!DOCTYPE refentry PUBLIC "-//OASIS//DTD DocBook XML V4.4//EN"
                         "http://www.oasis-open.org/docbook/xml/4.4/docbookx.dtd">
      <refentry id='ospack1'>
      <refmeta>
        <refentrytitle>ospack</refentrytitle>
        <manvolnum>1</manvolnum>
      </refmeta>
      <refnamediv>
        <refname>ospack</refname>
        <refpurpose>The missing package manager for macOS</refpurpose>
      </refnamediv>
      </refentry>
    XML
    system bin/"docbook2man", testpath/"ospack.1.xml"
    assert_predicate testpath/"ospack.1", :exist?, "Failed to create man page!"
  end
end
