class Dpkg < Formula
  ...
  def install
    ...
    # but the check for PERL_LIB remains in place and incompatible with Ospack.
  ...
  test do
    ...
    (testpath/"test/data/ospack.txt").write "ospack"
    ...
    assert_predicate testpath/"data/ospack.txt", :exist?
  end
end
