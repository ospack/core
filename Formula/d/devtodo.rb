class Devtodo < Formula
  ...
  bottle do
    sha256 arm64_sonoma:   "6557246b3de410895ef8dbce8620b0cd1fe999c5e0f6bb7882e75156cd07fc78"
    ...
    sha256 sonoma:         "10965ec4d7727421a9da1dd0ec0aff89f2c3c21f336e07758244a3c66057f9ff"
  ...
  test do
    (testpath/"test").write <<~EXPECT
      spawn #{bin}/devtodo --add OspackWork
      expect "priority*"
      send -- "2\r"
      expect eof
    EXPECT
    system "expect", "-f", "test"
    assert_match "OspackWork", (testpath/".todo").read
  end
end
