class Dynare < Formula
  ...
  def install
    ...
    # https://git.dynare.org/Dynare/dynare/-/blob/master/macOS/ospack-native-arm64.ini
  ...
  test do
    ...
    # Work around Xcode 15.0 ld error with GCC: https://github.com/ospack/core/issues/145991
