class DotnetAT6 < Formula
  ...
  resource "ospack-msbuild-patch" do
  ...
  def install
    ...
    (buildpath/"src/SourceBuild/tarball/patches/msbuild").install resource("ospack-msbuild-patch")
    ...
    (testpath/"test.csproj").write <<~XML
      <Project Sdk="Microsoft.NET.Sdk">
        <PropertyGroup>
          ...
          <RootNamespace>Ospack</RootNamespace>
          <PackageId>Ospack.Dotnet</PackageId>
          <Title>Ospack.Dotnet</Title>
