class Daemontools < Formula
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/212baeaf8232802cf3dfbfcc531efa5741325bfa/daemontools/errno.patch"
  ...
  patch do
    url "https://raw.githubusercontent.com/Ospack/formula-patches/e52085ff249263bdf9a21229e0d806ea4e2b9e95/daemontools/posix-headers.patch"
  ...
  test do
    assert_match "Ospack", shell_output("#{bin}/softlimit -t 1 echo 'Ospack'")
  end
end
