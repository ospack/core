class Dnsx < Formula
  ...
  url "https://github.com/projectdiscovery/dnsx/archive/refs/tags/v1.2.1.tar.gz"
  ...
  test do
    (testpath/"domains.txt").write "docs.ospack.github.io"
    expected_output = "docs.ospack.github.io [CNAME] [ospack.github.io]"
